...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str,
                        default='/home/lrz/Documents/Codes/yolov5_deepsort_test/yolov5/runs/train/exp11/weights/best.pt',
                        help='model.pt path')
    parser.add_argument('--deep_sort_weights', type=str,
                        default='/home/lrz/Documents/Codes/yolov5_deepsort_test/deep_sort_pytorch/deep_sort/deep/checkpoint/ckpt.t7',
                        help='ckpt.t7 path')
    # file/folder, 0 for webcam
    parser.add_argument('--source', type=str,
                        default='/home/lrz/Documents/Codes/yolov5_deepsort_test/video/', help='source')
